...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/NER1/dataset/geodata',
                        help="path to the preprocessed dataset")
    parser.add_argument('--output_dir', type=str, default='/NER1/output/entity_output',
                        help="output directory of the entity model")

    parser.add_argument('--max_span_length', type=int, default=25,
    ...
    parser.add_argument('--train_shuffle', action='store_true', default=1,
                        help="whether to train with randomly shuffled data")
    parser.add_argument('--do_eval', action='store_true', default=1,
                        help="whether to run evaluation")
    parser.add_argument('--eval_test', action='store_true', default=0,
    ...
    parser.add_argument('--use_albert', action='store_true', default=0,
