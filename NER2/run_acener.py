...
class ACEDatasetNER(Dataset):
    def __init__(self, tokenizer, args=None, evaluate=False, do_test=False):
        ...
        if args.data_dir.find('geodata')!=-1:
            self.ner_label_list = ['NIL', 'ALTE', 'CATE', 'DEPO', 'FAUL', 'GCA',
...
def main():
    ...
    ## Required parameters
    parser.add_argument("--data_dir", default='/NER2/dataset/geodata', type=str,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--model_type", default='bertspanmarker', type=str,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument("--model_name_or_path", default='/pretrained/bert-base-chinese', type=str,
                        help="Path to pre-trained model or shortcut name selected in the list: " + ", ".join(ALL_MODELS))
    parser.add_argument("--output_dir", default='/NER2/output/entity_output', type=str,
    ...
    parser.add_argument("--do_train", action='store_true', default=1,
                        help="Whether to run training.")
    parser.add_argument("--do_eval", action='store_true', default=1,
                        help="Whether to run eval on the dev set.")
    parser.add_argument("--do_test", action='store_true', default=1,
                        help="Whether to run test on the dev set.")

    parser.add_argument("--evaluate_during_training", action='store_true', default=1,
                        help="Rul evaluation during training at each logging step.")
    parser.add_argument("--do_lower_case", action='store_true', default=0,
    ...
    parser.add_argument("--eval_all_checkpoints", action='store_true', default=1,
                        help="Evaluate all checkpoints starting with the same prefix as model_name ending and ending with step number")
    parser.add_argument("--no_cuda", action='store_true', default=0,
                        help="Avoid using CUDA when available")
    parser.add_argument('--overwrite_output_dir', action='store_true', default=1,
                        help="Overwrite the content of the output directory")
    parser.add_argument('--overwrite_cache', action='store_true', default=1,
                        help="Overwrite the cached training and evaluation sets")
    parser.add_argument('--seed', type=int, default=42,
                        help="random seed for initialization")

    parser.add_argument('--fp16', action='store_true', default=0,
    ...
    parser.add_argument('--max_mention_ori_length', type=int, default=25,  help="")
    parser.add_argument('--lminit', action='store_true')
    parser.add_argument('--norm_emb', action='store_true')
    parser.add_argument('--output_results', action='store_true',default='/NER2/output/entity_output')
    ...
    if args.data_dir.find('ace')!=-1:
        num_labels = 8
    elif args.data_dir.find('geodata')!=-1:
        num_labels = 23 #7
